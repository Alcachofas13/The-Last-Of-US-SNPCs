...
if CLIENT then
	net.Receive("VJ_TLOU_Clicker_Controller",function(len,pl)
        ...
        local hookRSE = "VJ_TLOU_Clicker_Blindness" .. ent:EntIndex()
        ...
        if !delete then
			...
			net.Receive("VJ_TLOU_Clicker_Controller_Hear", function()
				...
				local hookListen = "VJ_TLOU_Clicker_Listen" .. soundEntity:EntIndex()
