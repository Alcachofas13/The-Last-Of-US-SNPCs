...
SWEP.WorldModel = "models/weapons/tlou/rifle_variable_s.mdl"
...
SWEP.Primary.Sound = {"weapons/tlou/variablerifle/fire1.wav","weapons/tlou/variablerifle/fire2.wav"}